...
def extract_img_features(
    ...
    text_features.to_csv(
        output_path + "/{}_level_texture_features.csv".format(feature_mask_shape)
    )
    intensity_features.to_csv(
        output_path + "/{}_level_intensity_features.csv".format(feature_mask_shape)
    )
...
if __name__ == "__main__":
    ...
    if os.path.exists(output_fn):
        ...
        _ = extract_img_features(input_path, input_type, output_path)
